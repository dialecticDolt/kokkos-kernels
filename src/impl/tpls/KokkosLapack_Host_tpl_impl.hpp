...
namespace KokkosBlas {
    namespace Impl {
        ...
        HostLapack<float>::unmqr(bool matrix_layout,
                                  ...
                                  float* work, int lwork){
            if(matrix_layout) {
                LAPACKE_sormqr_work(LAPACK_ROW_MAJOR, side, trans, m, n, k, a, lda, tau, c, ldc, work, lwork);
            }
            else {
                LAPACKE_sormqr_work(LAPACK_COL_MAJOR, side, trans, m, n, k, a, lda, tau, c, ldc, work, lwork);
            }
        }
        ...
        HostLapack<double>::unmqr(bool matrix_layout,
                                  ...
                                  double* work, int lwork){
            if(matrix_layout) {
                LAPACKE_dormqr_work(LAPACK_ROW_MAJOR, side, trans, m, n, k, a, lda, tau, c, ldc, work, lwork);
            }
            else {
                LAPACKE_dormqr_work(LAPACK_COL_MAJOR, side, trans, m, n, k, a, lda, tau, c, ldc, work, lwork);
            }
        }
