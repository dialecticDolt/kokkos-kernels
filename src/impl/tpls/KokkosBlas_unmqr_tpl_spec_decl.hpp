...
namespace KokkosBlas {
    ...
    #define KOKKOSBLAS_DUNMQR_WORKSPACE_LAPACK(LAYOUTA, LAYOUTB, LAYOUTC, MEMSPACE, ETI_SPEC_AVAIL) \
    template<class ExecSpace> \
    struct UNMQR_WORKSPACE< \
        ...
        int lwork = -1; \
        SCALAR query = 0; \
        HostLapack<SCALAR>::unmqr(A_is_lr, side, trans, M, N, k, A.data(), LDA, tau.data(), C.data(), LDC, &query, lwork); \
        Kokkos::Profiling::popRegion(); \
        return (int64_t) query; \
        } \
    };

    #define KOKKOSBLAS_SUNMQR_WORKSPACE_LAPACK(LAYOUTA, LAYOUTB, LAYOUTC, MEMSPACE, ETI_SPEC_AVAIL) \
    template<class ExecSpace> \
    struct UNMQR_WORKSPACE< \
        Kokkos::View<const float**, LAYOUTA, Kokkos::Device<ExecSpace, MEMSPACE>, \
                    Kokkos::MemoryTraits<Kokkos::Unmanaged> >, \
    ...
    #define KOKKOSBLAS_ZUNMQR_WORKSPACE_LAPACK(LAYOUTA, LAYOUTB, LAYOUTC, MEMSPACE, ETI_SPEC_AVAIL) \
    template<class ExecSpace> \
    struct UNMQR_WORKSPACE< \
        Kokkos::View<const Kokkos::complex<double>**, \
                    LAYOUTA, Kokkos::Device<ExecSpace, MEMSPACE>, \
    ...
    #define KOKKOSBLAS_CUNMQR_WORKSPACE_LAPACK(LAYOUTA, LAYOUTB, LAYOUTC, MEMSPACE, ETI_SPEC_AVAIL) \
    template<class ExecSpace> \
    struct UNMQR_WORKSPACE< \
        Kokkos::View<const Kokkos::complex<float>**, \
                    LAYOUTA, Kokkos::Device<ExecSpace, MEMSPACE>, \
        ...
        int lwork = -1; \
        SCALAR query = 0; \
        char type = (side == 'T' || side == 't') ? 'C' : side; \
        HostLapack<S2>::unmqr(A_is_lr, side, type, M, N, k, \
                reinterpret_cast<const S2*>(A.data()), LDA, \
                reinterpret_cast<const S2*>(tau.data()), \
                reinterpret_cast<S2*>(C.data()), LDC, \
                reinterpret_cast<S2*>(&query), lwork); \
    ...
    KOKKOSBLAS_DUNMQR_WORKSPACE_LAPACK(Kokkos::LayoutLeft, Kokkos::LayoutLeft, Kokkos::LayoutLeft, Kokkos::HostSpace, true)
    KOKKOSBLAS_DUNMQR_WORKSPACE_LAPACK(Kokkos::LayoutLeft, Kokkos::LayoutLeft, Kokkos::LayoutLeft, Kokkos::HostSpace, false)
    KOKKOSBLAS_DUNMQR_WORKSPACE_LAPACK(Kokkos::LayoutRight, Kokkos::LayoutRight, Kokkos::LayoutRight, Kokkos::HostSpace, true)
    KOKKOSBLAS_DUNMQR_WORKSPACE_LAPACK(Kokkos::LayoutRight, Kokkos::LayoutRight, Kokkos::LayoutRight, Kokkos::HostSpace, false)

    KOKKOSBLAS_SUNMQR_WORKSPACE_LAPACK(Kokkos::LayoutLeft, Kokkos::LayoutLeft, Kokkos::LayoutLeft, Kokkos::HostSpace, true)
    KOKKOSBLAS_SUNMQR_WORKSPACE_LAPACK(Kokkos::LayoutLeft, Kokkos::LayoutLeft, Kokkos::LayoutLeft, Kokkos::HostSpace, false)
    KOKKOSBLAS_SUNMQR_WORKSPACE_LAPACK(Kokkos::LayoutRight, Kokkos::LayoutRight, Kokkos::LayoutRight, Kokkos::HostSpace, true)
    KOKKOSBLAS_SUNMQR_WORKSPACE_LAPACK(Kokkos::LayoutRight, Kokkos::LayoutRight, Kokkos::LayoutRight, Kokkos::HostSpace, false)


    KOKKOSBLAS_ZUNMQR_WORKSPACE_LAPACK(Kokkos::LayoutLeft, Kokkos::LayoutLeft, Kokkos::LayoutLeft, Kokkos::HostSpace, true)
    KOKKOSBLAS_ZUNMQR_WORKSPACE_LAPACK(Kokkos::LayoutLeft, Kokkos::LayoutLeft, Kokkos::LayoutLeft, Kokkos::HostSpace, false)
    KOKKOSBLAS_ZUNMQR_WORKSPACE_LAPACK(Kokkos::LayoutRight, Kokkos::LayoutRight, Kokkos::LayoutRight, Kokkos::HostSpace, true)
    KOKKOSBLAS_ZUNMQR_WORKSPACE_LAPACK(Kokkos::LayoutRight, Kokkos::LayoutRight, Kokkos::LayoutRight, Kokkos::HostSpace, false)


    KOKKOSBLAS_CUNMQR_WORKSPACE_LAPACK(Kokkos::LayoutLeft, Kokkos::LayoutLeft, Kokkos::LayoutLeft, Kokkos::HostSpace, true)
    KOKKOSBLAS_CUNMQR_WORKSPACE_LAPACK(Kokkos::LayoutLeft, Kokkos::LayoutLeft, Kokkos::LayoutLeft, Kokkos::HostSpace, false)
    KOKKOSBLAS_CUNMQR_WORKSPACE_LAPACK(Kokkos::LayoutRight, Kokkos::LayoutRight, Kokkos::LayoutRight, Kokkos::HostSpace, true)
    KOKKOSBLAS_CUNMQR_WORKSPACE_LAPACK(Kokkos::LayoutRight, Kokkos::LayoutRight, Kokkos::LayoutRight, Kokkos::HostSpace, false)
...
namespace KokkosBlas{
    ...
    struct UNMQR< \
        ...
        cublasOperation_t m_trans = (trans == 'T' || trans == 't' || trans == 'C' || trans == 'c') ? CUBLAS_OP_T: CUBLAS_OP_N; \
        const int lwork = workspace.extent(0); \
    ...
    struct UNMQR< \
        ...
        const int CST = C_is_lr?C.stride(0):C.stride(1), LDC = CST == 0 ? 1:CST; \
        cublasSideMode_t m_side   = (side  == 'L' || side  == 'l') ? CUBLAS_SIDE_LEFT : CUBLAS_SIDE_RIGHT;\
        cublasOperation_t m_trans = (trans == 'T' || trans == 't' || trans == 'C' || trans == 'c') ? CUBLAS_OP_C: CUBLAS_OP_N; \
        const int lwork = workspace.extent(0); \
        KokkosBlas::Impl::CudaSolverSingleton & s = KokkosBlas::Impl::CudaSolverSingleton::singleton(); \
    ...
    #define KOKKOSBLAS_DUNMQR_WORKSPACE_CUSOLVER(LAYOUTA, LAYOUTB, LAYOUTC, MEMSPACE, ETI_SPEC_AVAIL) \
    template<class ExecSpace> \
    struct UNMQR_WORKSPACE< \
        Kokkos::View<const double**, LAYOUTA, Kokkos::Device<ExecSpace, MEMSPACE>, \
                    Kokkos::MemoryTraits<Kokkos::Unmanaged> >, \
    ...
    #define KOKKOSBLAS_SUNMQR_WORKSPACE_CUSOLVER(LAYOUTA, LAYOUTB, LAYOUTC, MEMSPACE, ETI_SPEC_AVAIL) \
    template<class ExecSpace> \
    struct UNMQR_WORKSPACE< \
        Kokkos::View<const float**, LAYOUTA, Kokkos::Device<ExecSpace, MEMSPACE>, \
                    Kokkos::MemoryTraits<Kokkos::Unmanaged> >, \
        ...
        int lwork = 0; \
        KokkosBlas::Impl::CudaSolverSingleton & s = KokkosBlas::Impl::CudaSolverSingleton::singleton(); \
        cusolverDnSormqr_bufferSize(s.handle, m_side, m_trans, M, N, k, A.data(), LDA, tau.data(), C.data(), LDC, &lwork); \
        Kokkos::Profiling::popRegion(); \
        return (int64_t) lwork; \
        } \
    };

    #define KOKKOSBLAS_ZUNMQR_WORKSPACE_CUSOLVER(LAYOUTA, LAYOUTB, LAYOUTC, MEMSPACE, ETI_SPEC_AVAIL) \
    template<class ExecSpace> \
    struct UNMQR_WORKSPACE< \
        Kokkos::View<const Kokkos::complex<double>**, LAYOUTA, Kokkos::Device<ExecSpace, MEMSPACE>, \
                    Kokkos::MemoryTraits<Kokkos::Unmanaged> >, \
    ...
    #define KOKKOSBLAS_CUNMQR_WORKSPACE_CUSOLVER(LAYOUTA, LAYOUTB, LAYOUTC, MEMSPACE, ETI_SPEC_AVAIL) \
    template<class ExecSpace> \
    struct UNMQR_WORKSPACE< \
        Kokkos::View<const Kokkos::complex<float>**, LAYOUTA, Kokkos::Device<ExecSpace, MEMSPACE>, \
                    Kokkos::MemoryTraits<Kokkos::Unmanaged> >, \
    ...
    KOKKOSBLAS_DUNMQR_WORKSPACE_CUSOLVER(Kokkos::LayoutLeft, Kokkos::LayoutLeft, Kokkos::LayoutLeft, Kokkos::CudaSpace, true)
    KOKKOSBLAS_DUNMQR_WORKSPACE_CUSOLVER(Kokkos::LayoutLeft, Kokkos::LayoutLeft, Kokkos::LayoutLeft, Kokkos::CudaSpace, false)

    KOKKOSBLAS_SUNMQR_WORKSPACE_CUSOLVER(Kokkos::LayoutLeft, Kokkos::LayoutLeft, Kokkos::LayoutLeft, Kokkos::CudaSpace, true)
    KOKKOSBLAS_SUNMQR_WORKSPACE_CUSOLVER(Kokkos::LayoutLeft, Kokkos::LayoutLeft, Kokkos::LayoutLeft, Kokkos::CudaSpace, false)

    KOKKOSBLAS_ZUNMQR_WORKSPACE_CUSOLVER(Kokkos::LayoutLeft, Kokkos::LayoutLeft, Kokkos::LayoutLeft, Kokkos::CudaSpace, true)
    KOKKOSBLAS_ZUNMQR_WORKSPACE_CUSOLVER(Kokkos::LayoutLeft, Kokkos::LayoutLeft, Kokkos::LayoutLeft, Kokkos::CudaSpace, false)

    KOKKOSBLAS_CUNMQR_WORKSPACE_CUSOLVER(Kokkos::LayoutLeft, Kokkos::LayoutLeft, Kokkos::LayoutLeft, Kokkos::CudaSpace, true)
    KOKKOSBLAS_CUNMQR_WORKSPACE_CUSOLVER(Kokkos::LayoutLeft, Kokkos::LayoutLeft, Kokkos::LayoutLeft, Kokkos::CudaSpace, false)
