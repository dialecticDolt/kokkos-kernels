...
namespace KokkosBlas {
    ...
    struct GEQRF< \
        ...
        HostLapack<SCALAR>::geqrf(A_is_lr, M, N, A.data(), LDA, tau.data(), workspace.data(), lwork); \
    ...
    struct GEQRF< \
        ...
        HostLapack<SCALAR>::geqrf(A_is_lr, M, N,  \
                ...
                reinterpret_cast<SCALAR*>(workspace.data()), lwork); \
        Kokkos::Profiling::popRegion(); \
        } \
    };
    ...
    KOKKOSBLAS_DGEQRF_WORKSPACE_LAPACK(Kokkos::LayoutRight,Kokkos::HostSpace, false)
    ...
    KOKKOSBLAS_SGEQRF_WORKSPACE_LAPACK(Kokkos::LayoutRight, Kokkos::HostSpace, false)
    ...
    KOKKOSBLAS_ZGEQRF_WORKSPACE_LAPACK(Kokkos::LayoutRight, Kokkos::HostSpace, false)
    ...
    KOKKOSBLAS_CGEQRF_WORKSPACE_LAPACK(Kokkos::LayoutRight, Kokkos::HostSpace, false)
...
namespace KokkosBlas{
    ...
    //WORKSPACE_QUERIES
     ...
     #define KOKKOSBLAS_DGEQRF_WORKSPACE_CUSOLVER(LAYOUTA,MEMSPACE, ETI_SPEC_AVAIL) \
    template<class ExecSpace> \
    struct GEQRF_WORKSPACE< \
        Kokkos::View<double**, LAYOUTA, Kokkos::Device<ExecSpace, MEMSPACE>, \
                    Kokkos::MemoryTraits<Kokkos::Unmanaged> >, \
    ...
    #define KOKKOSBLAS_SGEQRF_WORKSPACE_CUSOLVER(LAYOUTA, MEMSPACE, ETI_SPEC_AVAIL) \
    template<class ExecSpace> \
    struct GEQRF_WORKSPACE< \
        Kokkos::View<float**, LAYOUTA, Kokkos::Device<ExecSpace, MEMSPACE>, \
                    Kokkos::MemoryTraits<Kokkos::Unmanaged> >, \
    ...
    #define KOKKOSBLAS_ZGEQRF_WORKSPACE_CUSOLVER(LAYOUTA, MEMSPACE, ETI_SPEC_AVAIL) \
    template<class ExecSpace> \
    struct GEQRF_WORKSPACE< \
        Kokkos::View<Kokkos::complex<double>**, LAYOUTA, Kokkos::Device<ExecSpace, MEMSPACE>, \
                    Kokkos::MemoryTraits<Kokkos::Unmanaged> >, \
    ...
    #define KOKKOSBLAS_CGEQRF_WORKSPACE_CUSOLVER(LAYOUTA, MEMSPACE, ETI_SPEC_AVAIL) \
    template<class ExecSpace> \
    struct GEQRF_WORKSPACE< \
        Kokkos::View<Kokkos::complex<float>**, LAYOUTA, Kokkos::Device<ExecSpace, MEMSPACE>, \
                    Kokkos::MemoryTraits<Kokkos::Unmanaged> >, \
    ...
    KOKKOSBLAS_DGEQRF_WORKSPACE_CUSOLVER(Kokkos::LayoutLeft, Kokkos::CudaSpace, true)
    KOKKOSBLAS_DGEQRF_WORKSPACE_CUSOLVER(Kokkos::LayoutLeft, Kokkos::CudaSpace, false)

    KOKKOSBLAS_SGEQRF_WORKSPACE_CUSOLVER(Kokkos::LayoutLeft, Kokkos::CudaSpace, true)
    KOKKOSBLAS_SGEQRF_WORKSPACE_CUSOLVER(Kokkos::LayoutLeft, Kokkos::CudaSpace, false)

    KOKKOSBLAS_ZGEQRF_WORKSPACE_CUSOLVER(Kokkos::LayoutLeft, Kokkos::CudaSpace, true)
    KOKKOSBLAS_ZGEQRF_WORKSPACE_CUSOLVER(Kokkos::LayoutLeft, Kokkos::CudaSpace, false)

    KOKKOSBLAS_CGEQRF_WORKSPACE_CUSOLVER(Kokkos::LayoutLeft, Kokkos::CudaSpace, true)
    KOKKOSBLAS_CGEQRF_WORKSPACE_CUSOLVER(Kokkos::LayoutLeft, Kokkos::CudaSpace, false)
