#ifndef KOKKOSBLAS_TRMM_HPP_
#define KOKKOSBLAS_TRMM_HPP_

#include <KokkosKernels_Macros.hpp>
#include "KokkosBlas_trmm_spec.hpp"
...
/* 
 * \brief Dense TRMM (Device Level) Triangular Matrix Multiply
 ...
 */
    ...
    void trmm(const char side[], const char uplo[], const char transa[], const char diag[],
        ...
        static_assert(Kokkos::Impl::is_view<AViewType>::value, "KokkosBlas::trmm: A must be a Kokkos::View");
        static_assert(Kokkos::Impl::is_view<BViewType>::value, "KokkosBlas::trmm: B  must be a Kokkos::View");
        static_assert(static_cast<int> (AViewType::rank)==2, "KokkosBlas::trmm: A must have rank 2");
        
        static_assert(static_cast<int> (AViewType::rank)==2, "KokkosBlas::trmm: B must have rank 2");
        ...
        typedef KokkosBlas::Impl::TRMM<AVT, BVT> impl_type;
        impl_type::trmm(side[0], uplo[0], transa[0], diag[0], alpha, A_i, B_i);

    }

} //namespace KokkosBlas

#endif //KOKKOSBLAS_TRMM_HPP_
