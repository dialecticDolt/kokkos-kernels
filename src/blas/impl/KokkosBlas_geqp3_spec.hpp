...
#define KOKKOSBLAS_GEQP3_ETI_SPEC_AVAIL(SCALAR_TYPE, LAYOUT_TYPE, EXEC_SPACE_TYPE, MEM_SPACE_TYPE)\
    template<> \
    struct geqp3_eti_spec_avail< \
...
#define KOKKOSBLAS_GEQP3_ETI_SPEC_DECL(SCALAR_TYPE, LAYOUT_TYPE, EXEC_SPACE_TYPE, MEM_SPACE_TYPE) \
...
#define KOKKOSBLAS_GEQP3_ETI_SPEC_INST(SCALAR_TYPE, LAYOUT_TYPE, EXEC_SPACE_TYPE, MEM_SPACE_TYPE) \
    template struct \
    GEQP3< Kokkos::View<SCALAR_TYPE**, LAYOUT_TYPE, \
                        Kokkos::Device<EXEC_SPACE_TYPE, MEM_SPACE_TYPE>, \
                        Kokkos::MemoryTraits<Kokkos::Unmanaged> > , \
...
#include<generated_specializations_hpp/KokkosBlas_geqp3_eti_spec_decl.hpp>
